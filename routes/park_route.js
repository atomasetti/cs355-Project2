...
var parkDal = require('../model/park_dal');


router.get('/all', function(req, res)
{
    parkDal.GetAll(function (err, result)
    {
//        console.log(result);
        if (err)
            throw err;
...
router.get('/editLocation', function(req, res){
    console.log('/editLocation park_id:' + req.query.park_id);
    ...
    parkDal.GetByID(req.query.park_id, function(err, park_result){
        if(err) {
            ...
            res.render('parkLocation_edit_form.ejs', {rs: park_result,  message: req.query.message});
        }
    });
});


router.get('/editCoaster', function(req, res){
    console.log('/edit park_id:' + req.query.park_id);
